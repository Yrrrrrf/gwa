...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
    <GlassCard class="p-5 flex flex-col items-center text-center">
      <h3
        class="text-[10px] font-bold uppercase tracking-widest text-base-content/50"
      >
        Total Items
      </h3>
    ...
    <GlassCard
      class="p-5 flex flex-col items-center text-center relative overflow-hidden"
    >
      <div class="absolute inset-0 bg-warning/5 animate-pulse"></div>
      <h3
        class="text-[10px] font-bold uppercase tracking-widest text-base-content/50 relative z-10"
      >
        Pending
      </h3>
      <p class="text-3xl font-black text-warning mt-1 relative z-10">
        {stats.pending}
      </p>
    </GlassCard>
  </div>
  ...
  <GlassCard class="overflow-hidden">
    <div
      class="p-5 border-b border-base-content/5 flex items-center justify-between"
    >
        ...
        <tbody>
            ...
            <tr class="hover:bg-base-200/50 transition-colors">
              <td class="font-bold text-sm">
                ...
                {#if item.status === "pending"}
                  <span class="badge badge-error badge-xs ml-2 animate-bounce"
                    >NEW</span
                  >
                {/if}
              </td>
          ...
          {#if items.length === 0}
            <tr>
              <td
                colspan="4"
                class="text-center py-8 text-base-content/40 text-sm font-medium"
              >
                No items found.
              </td>
            </tr>
